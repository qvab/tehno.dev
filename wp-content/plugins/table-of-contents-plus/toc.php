	...
	class toc {
		...
		function wp_enqueue_scripts()
		{
			...
			if ( $this->options['show_heading_text'] && $this->options['visibility'] ) {
				...
				// TODO mishanin correction translate
				$js_vars['visibility_show'] = esc_js($_COOKIE["wp-wpml_current_language"] == "ru" ? $this->options['visibility_show'] : "Show");
				$js_vars['visibility_hide'] = esc_js($_COOKIE["wp-wpml_current_language"] == "ru" ? $this->options['visibility_hide'] : "Hide");
				...
				if ( $items ) {
					...
					if ( $this->options['show_toc_in_widget_only'] && (in_array(get_post_type(), $this->options['show_toc_in_widget_only_post_types'])) ) {
						...
						if ( $this->options['show_heading_text'] ) {
						    if ($_COOKIE["wp-wpml_current_language"] != "en") {
